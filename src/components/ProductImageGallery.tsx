        ...
        <div className="w-full lg:flex-1 p-3 sm:p-4 bg-[#EFEAE1] rounded-2xl border border-[#E4DED3]">
          ...
          >
            ...
            {hasMultiple && (
              <>
                <button
                  ...
                  className="absolute left-3 top-1/2 -translate-y-1/2 w-10 h-10 rounded-full bg-white/90 hover:bg-white shadow-[0_2px_10px_rgba(0,0,0,0.15)] flex items-center justify-center text-[#1C1A18] transition-all duration-200 cursor-pointer z-10"
                >
                ...
                <button
                  ...
                  className="absolute right-3 top-1/2 -translate-y-1/2 w-10 h-10 rounded-full bg-white/90 hover:bg-white shadow-[0_2px_10px_rgba(0,0,0,0.15)] flex items-center justify-center text-[#1C1A18] transition-all duration-200 cursor-pointer z-10"
                >
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden="true">
            ...
            <button
              ...
              className={`absolute top-3 right-3 w-10 h-10 rounded-full bg-white/90 hover:bg-white shadow-[0_2px_10px_rgba(0,0,0,0.15)] flex items-center justify-center text-[#1C1A18] transition-all duration-200 cursor-pointer z-10 ${
                pinnedZoom ? 'ring-2 ring-[#C8A96E] text-[#B5533C]' : ''
              }`}
            >
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden="true">
          ...
          >
            {images.map((img, i) => (
              <button
                ...
                className={`shrink-0 aspect-[3/4] w-16 lg:w-full rounded-lg overflow-hidden border-2 transition-all duration-200 cursor-pointer bg-[#EFEAE1] flex items-center justify-center ${
                  i === activeIdx
                    ? 'border-[#C8A96E]'
